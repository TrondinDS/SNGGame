...
namespace StudioGameService.Migrations
{
    ...
    public partial class Create : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RussianTitle = table.Column<string>(
                        type: "character varying(255)",
                        maxLength: 255,
                        nullable: false
                    ),
                    EnglishTitle = table.Column<string>(
                        type: "character varying(255)",
                        maxLength: 255,
                        nullable: false
                    ),
                    AlternativeTitle = table.Column<string>(
                        type: "character varying(255)",
                        maxLength: 255,
                        nullable: false
                    ),
                    ...
                    CountryDevelopment = table.Column<string>(
                        type: "character varying(255)",
                        maxLength: 255,
                        nullable: false
                    ),
                    LinkPageStore = table.Column<string>(
                        type: "character varying(255)",
                        maxLength: 255,
                        nullable: false
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "GameLibraries");

            migrationBuilder.DropTable(name: "GameSelectedGenres");

            migrationBuilder.DropTable(name: "GameSelectedTags");
