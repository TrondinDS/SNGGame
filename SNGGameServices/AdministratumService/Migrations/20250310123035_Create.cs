...
namespace AdministratumService.Migrations
{
    ...
    public partial class Create : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusUpdateDatetime = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "UserComplains");

            migrationBuilder.DropTable(name: "ChatFeedbacks");

            migrationBuilder.DropTable(name: "ComplainTickets");
        }
    }
}
